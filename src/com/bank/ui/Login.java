...
public class Login extends JFrame {
	...
	private JLabel backgroundCon;				/*±≥æ∞Õº∆¨»›∆˜*/
	private JLabel label1;
	private JLabel label2;
	private JLabel label;				/*±ÍÃ‚*/
	...
	public Login(){
		...
		//…Ë÷√±Í«©
		label1 = new JLabel("”√ªßID:");
		label2 = new JLabel("√‹¬Î:");
		label = new JLabel("»Ó œ“¯––π‹¿ÌœµÕ≥");
		label.setFont(new Font("ø¨ÃÂ",Font.BOLD,32));
		label1.setFont(new Font("ø¨ÃÂ",Font.BOLD , 16));
		label2.setFont(new Font("ø¨ÃÂ",Font.BOLD , 16));
		...
		logBut = new JButton();
		exitBut = new JButton();
//		RegBut.setFont(new Font("Œ¢»Ì—≈∫⁄",Font.PLAIN,16));
//		logBut.setFont(new Font("Œ¢»Ì—≈∫⁄",Font.PLAIN,16));
//		exitBut.setFont(new Font("Œ¢»Ì—≈∫⁄",Font.PLAIN,16));
		RegBut.setBounds(220, 280,120, 36);
		logBut.setBounds(350, 280,120, 36);
		exitBut.setBounds(480, 280,120, 36);
		RegBut.setContentAreaFilled(false);			/*“Ï≥£*/
		logBut.setContentAreaFilled(false);			/*“Ï≥£*/
		exitBut.setContentAreaFilled(false);			/*“Ï≥£*/
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(userIdField.getText() != null && String.valueOf(userPwdField.getPassword()) != null){
					...
					if(flag){
						...
						JOptionPane.showMessageDialog(null, "µ«¬Ω ß∞‹","µ«¬Ω“Ï≥£", JOptionPane.ERROR_MESSAGE);
					}
				}
